 ...
 * @method static array<int, string> files(string $path) Get all files in a directory
 * @method static array<int, string> directories(string $path) Get all directories in a path
 ...
 *
 * @extends Facade<FilesystemInterface>
 */
